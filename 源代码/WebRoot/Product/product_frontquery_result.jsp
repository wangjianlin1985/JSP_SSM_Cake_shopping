...
<%
    ...
    String recipeFlag = (String)request.getAttribute("recipeFlag"); //是否个性DIY制作蛋糕查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color:#B6DDE5;">
...
<div class="container">
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" style="width:268px;height:268px;"/></a>
			     <div class="showFields ">
			     	...
			     	<div class="field showFields1">
	            		是否个性DIY制作蛋糕:<%=product.getRecipeFlag() %>
			     	</div>
			     	<div class="field showFields1">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
			...
			<div class="form-group">
				<label for="recipeFlag">是否个性DIY制作蛋糕:</label>
				<input type="text" id="recipeFlag" name="recipeFlag" value="<%=recipeFlag %>" class="form-control" placeholder="请输入是否个性DIY制作蛋糕">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="product_recipeFlag_edit" class="col-md-3 text-right">是否个性DIY制作蛋糕:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_recipeFlag_edit" name="product.recipeFlag" class="form-control" placeholder="请输入是否个性DIY制作蛋糕">
			 </div>
		  </div>
		  <div class="form-group">

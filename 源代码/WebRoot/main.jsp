...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#E9546B;">
	<div class="logo">蛋糕制作</div>
...
<div data-options="region:'center'" style="overflow:hidden;">
	<div id="tabs">
		<div title="起始页" iconCls="icon-house" style="padding:0 10px;display:block;font-size:70px">
			 <img src="<%=basePath%>/images/houtaibg.jpg" style="background-size: cover;width:100%;height:100%;"></img>
		</div>
	</div>
</div> 

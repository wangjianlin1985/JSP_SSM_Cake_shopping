	...
	<div class="row">
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
  			...
  			<div style="text-align:center;color:#FF5252 ; font-size: 30px;">留言</div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="leavewordAdd"> 
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxLeavewordAdd();" class="btn btn-primary bottom5 top5">我要留言</span>
				          </div>
						</form> 
				        <style>#leavewordAddForm .form-group {margin:50px;}  </style>
					</div>
				</div>
			</div>
		</div>

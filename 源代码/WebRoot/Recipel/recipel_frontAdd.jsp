...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Recipel/frontlist">个性DIY制作管理</a></li>
  			<li class="active">添加个性DIY制作</li>
		</ul>
		<div class="row">
			<div class="col-md-10">
		          ...
		          <div class="form-group">
		             ...
		             <span onclick="ajaxRecipelAdd();" class="btn btn-primary bottom5 top5">添加</span>
		          </div> 
		          <style>#recipelAddForm .form-group {margin:5px;}  </style>  
				</form> 
			</div>

...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Recipel/frontlist">个性DIY制作信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Recipel/recipel_frontAdd.jsp" style="display:none;">添加个性DIY制作</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Recipel/<%=recipel.getRecipelId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=recipel.getRecipelPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		个性DIY制作id:<%=recipel.getRecipelId() %>
			     	</div>
			     	<div class="field">

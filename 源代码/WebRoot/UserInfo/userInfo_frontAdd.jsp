...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-8 wow fadeInLeft">
		<div style="  margin-top:40px; margin-bottom:40px;">
  			...
  			<div style="text-align:center;color:#FF5252 ; font-size: 30px;">注册</div>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group"  style="display:none;">
				  	 <label for="userInfo_userMoney" class="col-md-2 text-right">账户余额:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_userMoney" name="userInfo.userMoney" class="form-control" placeholder="请输入账户余额">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
		          ...
		          <style>#userInfoAddForm .form-group {margin:20px;}  </style>  
				</form> 
			</div>

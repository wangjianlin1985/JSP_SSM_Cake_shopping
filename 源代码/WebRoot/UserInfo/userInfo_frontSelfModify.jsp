...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<div style="  margin-top:40px; margin-bottom:40px;">
  			...
  			<div style="text-align:center;color:#FF5252 ; font-size: 30px;">修改个人信息</div>
		...
		<div class="row"> 
		  ...
		  <div class="form-group" style="display:none;">
		  	 <label for="userInfo_userMoney_edit" class="col-md-3 text-right">账户余额:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_userMoney_edit" name="userInfo.userMoney" class="form-control" placeholder="请输入账户余额">
			 </div>
		  </div>
		  <div class="form-group" style="display:none;">
	    ...
	    <style>#userInfoEditForm .form-group {margin-bottom:5px;margin-leftt:200px;}  </style>
      </div>
   </div>
</div>
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_userMoney_edit").val(userInfo.userMoney);

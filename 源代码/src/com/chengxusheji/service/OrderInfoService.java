...
public class OrderInfoService {
    ...
    /*按照查询条件分页查询订单记录*/
    public ArrayList<OrderInfo> queryOrderInfo(String orderNo,UserInfo userObj,String orderStateObj,String orderTime,String receiveName,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<OrderInfo> queryOrderInfo(String orderNo,UserInfo userObj,String orderStateObj,String orderTime,String receiveName,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!orderNo.equals("")) where = where + " and t_orderInfo.orderNo like '%" + orderNo + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_orderInfo.userObj='" + userObj.getUser_name() + "'";
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String orderNo,UserInfo userObj,String orderStateObj,String orderTime,String receiveName,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!orderNo.equals("")) where = where + " and t_orderInfo.orderNo like '%" + orderNo + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_orderInfo.userObj='" + userObj.getUser_name() + "'";
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
